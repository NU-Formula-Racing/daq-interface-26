...
SELECT _postgis_package_object('AGGREGATE', 'CG_3DUnion (geometry)');
SELECT _postgis_package_object('AGGREGATE', 'ST_3DUnion (geometry)');
SELECT _postgis_package_object('AGGREGATE', 'CG_Union (geometry)');
...
SELECT _postgis_package_object('FUNCTION', 'CG_3DIntersection (geom1 geometry, geom2 geometry)');
SELECT _postgis_package_object('FUNCTION', 'ST_3DIntersection (geom1 geometry, geom2 geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_Intersection (geom1 geometry, geom2 geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_3DIntersects (geom1 geometry, geom2 geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_Intersects (geom1 geometry, geom2 geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_3DDifference (geom1 geometry, geom2 geometry)');
SELECT _postgis_package_object('FUNCTION', 'ST_3DDifference (geom1 geometry, geom2 geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_Difference (geom1 geometry, geom2 geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_3DUnion (geom1 geometry, geom2 geometry)');
SELECT _postgis_package_object('FUNCTION', 'ST_3DUnion (geom1 geometry, geom2 geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_Union (geom1 geometry, geom2 geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_Tesselate (geometry)');
SELECT _postgis_package_object('FUNCTION', 'ST_Tesselate (geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_Triangulate (geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_3DArea (geometry)');
SELECT _postgis_package_object('FUNCTION', 'ST_3DArea (geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_Area (geom1 geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_3DDistance (geometry, geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_Distance (geometry, geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_Extrude (geometry, float8, float8, float8)');
SELECT _postgis_package_object('FUNCTION', 'ST_Extrude (geometry, float8, float8, float8)');
SELECT _postgis_package_object('FUNCTION', 'CG_ForceLHR (geometry)');
SELECT _postgis_package_object('FUNCTION', 'ST_ForceLHR (geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_Orientation (geometry)');
SELECT _postgis_package_object('FUNCTION', 'ST_Orientation (geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_MinkowskiSum (geometry, geometry)');
SELECT _postgis_package_object('FUNCTION', 'ST_MinkowskiSum (geometry, geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_StraightSkeleton (geometry, use_m_as_distance boolean )');
SELECT _postgis_package_object('FUNCTION', 'ST_StraightSkeleton (geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_ApproximateMedialAxis (geometry)');
SELECT _postgis_package_object('FUNCTION', 'ST_ApproximateMedialAxis (geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_IsPlanar (geometry)');
SELECT _postgis_package_object('FUNCTION', 'ST_IsPlanar (geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_Volume (geometry)');
SELECT _postgis_package_object('FUNCTION', 'ST_Volume (geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_MakeSolid (geometry)');
SELECT _postgis_package_object('FUNCTION', 'ST_MakeSolid (geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_IsSolid (geometry)');
SELECT _postgis_package_object('FUNCTION', 'ST_IsSolid (geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_ConstrainedDelaunayTriangles (geometry)');
SELECT _postgis_package_object('FUNCTION', 'ST_ConstrainedDelaunayTriangles (geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_3DConvexHull (geometry)');
SELECT _postgis_package_object('FUNCTION', 'ST_3DConvexHull (geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_AlphaShape (g1 geometry, alpha float8 , allow_holes boolean )');
SELECT _postgis_package_object('FUNCTION', 'ST_AlphaShape (g1 geometry, alpha float8 , allow_holes boolean )');
SELECT _postgis_package_object('FUNCTION', 'CG_OptimalAlphaShape (g1 geometry, allow_holes boolean , nb_components int )');
SELECT _postgis_package_object('FUNCTION', 'ST_OptimalAlphaShape (g1 geometry, allow_holes boolean , nb_components int )');
SELECT _postgis_package_object('FUNCTION', 'CG_YMonotonePartition (g1 geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_ApproxConvexPartition (g1 geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_GreeneApproxConvexPartition (g1 geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_OptimalConvexPartition (g1 geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_ExtrudeStraightSkeleton (g1 geometry, top_height float8, body_height float8 )');
SELECT _postgis_package_object('FUNCTION', 'CG_Visibility (polygon geometry, pointA geometry, pointB geometry)');
SELECT _postgis_package_object('FUNCTION', 'CG_Visibility (polygon geometry, point geometry)');
-- Register all types.
